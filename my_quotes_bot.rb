...
tweet mytweets.pickup_quote + mytweets.pickup_emoji

#
# Hello! This is some starter code for your bot. You will need to keep
# this file and my_quotes_bot.yml together to run your bot. The .yml file
...
# puts 'Hey there! You should open my_quotes_bot.rb and take a look before running this script.'
...
# my_quotes_bot.yml into the commands.
#
